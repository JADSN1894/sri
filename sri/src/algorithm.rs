...
impl AlgorithmSri {
  ...
  fn hash(&self, data: String) -> SriResult<String> {
    match self {
      ...
      AlgorithmSri::Unknown(invalid_algorithm) => Err(
        SriErrorTypes::InvalidAlgorithm(invalid_algorithm.to_string().into())
          .into(),
      ),
    }
  }
...
impl From<String> for AlgorithmSri {
